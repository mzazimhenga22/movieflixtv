...
class InteractiveFeaturesScreen extends StatefulWidget {
  ...
  @override
  _InteractiveFeaturesScreenState createState() => _InteractiveFeaturesScreenState();
}
...
class _InteractiveFeaturesScreenState extends State<InteractiveFeaturesScreen> {
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [settings.accentColor.withOpacity(0.3), settings.accentColor.withOpacity(0.5)],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.settings, color: settings.accentColor, size: 30),
            onPressed: () {
              Navigator.push(
                context,
                                  ...
                                  FocusScope(
                                    child: Focus(
                                      ...
                                      child: FeatureCard(
                                        ...
                                        borderColor: settings.accentColor.withOpacity(0.5),
                                        ...
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const WatchPartyScreen()),
                                          );
                                        },
                                      ),
                                    ),
                                    ...
                                    child: Focus(
                                      ...
                                      child: FeatureCard(
                                        ...
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const InPlaybackTriviaScreen()),
                                          );
                                        },
                                      ),
                                    ),
                                  ...
                                  FocusScope(
                                    child: Focus(
                                      ...
                                      child: FeatureCard(
                                        ...
                                        subtitle: "Experience AR with movie posters and interactive virtual objects.",
                                        backgroundGradient: LinearGradient(
                                          colors: [settings.accentColor.withOpacity(0.2), settings.accentColor.withOpacity(0.4)],
                                          begin: Alignment.topLeft,
                                          end: Alignment.bottomRight,
                                        ...
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const ARModeScreen()),
                                          );
                                        },
                                      ),
                                    ),
                                  ...
                                  FocusScope(
                                    child: Focus(
                                      ...
                                      child: FeatureCard(
                                        ...
                                        title: "Personalized Watchlists & AI Recommendations",
                                    ...
                                    child: Focus(
                                      ...
                                      child: FeatureCard(
                                        ...
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const BehindTheScenesScreen()),
                                          );
                                        },
                                      ),
                                    ),
  ...
  builder: (context) => ThemeSettingsScreen(
    currentTheme: widget.isDarkMode ?? false ? "Dark" : "Light",
    onThemeChanged: widget.onThemeChanged != null
        ? (String newTheme) => widget.onThemeChanged!(newTheme == "Dark")
        : (String newTheme) => {},
  ),
),
                                          );
                                      ...
                                      child: FeatureCard(
                                        ...
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (_) => SocialReactionsScreen(accentColor: settings.accentColor),
                                            ),
                                          );
                                        },
                                      ),
